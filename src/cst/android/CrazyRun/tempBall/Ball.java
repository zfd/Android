...
import static cst.android.CrazyRun.tempBall.ShaderUtil.createProgram;
...
public class Ball {
    ...
    public Ball(GameView mv, float scale, float aHalf, int n, int textId) {
