package cst.android.CrazyRun.gold;

import android.opengl.GLES20;
import cst.android.CrazyRun.main.GameView;
import cst.android.CrazyRun.tempBall.ShaderUtil;
...
public class CylinderSide
{
    ...
    public CylinderSide(GameView mv,float scale,float r,float h,int n)
    {
    ...
    {
    	//加载顶点着色器的脚本内容
        mVertexShader= ShaderUtil.loadFromAssetsFile("gold_vertex_tex_light.sh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader=ShaderUtil.loadFromAssetsFile("gold_frag_tex_light.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
