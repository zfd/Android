 ...
 */
public class Sky {
//    static final float UNIT_SIZE=15.0f;
    //自定义渲染程序的引用
    int mProgram;
    //总变换矩阵的引用
    ...
    public Sky(GameView mv)
    {
        initVertexData(Constant.SKY_R);
        initShader(mv);
    }
    //初始化顶点数据的方法
    ...
    {
        String mVertexHandle= ShaderUtil.loadFromAssetsFile("sky_vertex.sh", mv.getResources());
        String mTexCoorHandle= ShaderUtil.loadFromAssetsFile("sky_frag.sh", mv.getResources());
